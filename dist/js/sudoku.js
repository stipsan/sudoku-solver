	...
	(function () {
	    ...
	    var Sudoku = function(SudokuInstance){
	        ...
	        // private methods:
	            ...
	            if(false) console.log(_cell, _candidates, _masks);
	    ...
	    var Handler = React.createClass({displayName: "Handler",
	        ...
	        render: function(){
	                    ...
	                    for (i = 1; i <= 3; i++){
	                        ...
	                        for (j = 1; j <= 3; j++){
	                            ...
	                            if (num_candidates == 1 || cell.hasOwnProperty('userDefined') && cell.userDefined){
	                                ...
	                                cell.html = React.createElement("pre", {ref: "candidates"+abs_i+""+abs_j}, contents);
	                            }
	                            ...
	                            cells[I][J][i].push(React.createElement("td", {
	                        ...
	                        rows[I][J].include(React.createElement("tr", null, 
	                            cells[I][J][i]
	                        ));
	                    }
	                    
	                    cols[I].include(React.createElement("td", null, 
	                        React.createElement("table", {className: "block", id: "b"+I+""+J}, React.createElement("tbody", null, rows[I][J]))
	                    ));
	                }
	                
	                blocks.include(React.createElement("tr", null, cols[I]));
	            ...
	            return (React.createElement("div", {id: "sudoku_wrapper"}, 
	                    ...
	                    React.createElement("tbody", null, blocks)
	                ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactContext = __webpack_require__(7);
	var ReactCurrentOwner = __webpack_require__(8);
	var ReactElement = __webpack_require__(9);
	var ReactElementValidator = __webpack_require__(10);
	...
	var ReactPropTypes = __webpack_require__(17);
	var ReactReconciler = __webpack_require__(18);
	var ReactServerRendering = __webpack_require__(19);

	var assign = __webpack_require__(20);
	var findDOMNode = __webpack_require__(21);
	var onlyChild = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChangeEventPlugin = __webpack_require__(45);
	var ClientReactRootIndex = __webpack_require__(46);
	var DefaultEventPluginOrder = __webpack_require__(47);
	var EnterLeaveEventPlugin = __webpack_require__(48);
	var ExecutionEnvironment = __webpack_require__(49);
	var HTMLDOMPropertyConfig = __webpack_require__(50);
	var MobileSafariClickEventPlugin = __webpack_require__(51);
	var ReactBrowserComponentMixin = __webpack_require__(52);
	var ReactClass = __webpack_require__(6);
	var ReactComponentBrowserEnvironment =
	  __webpack_require__(41);
	var ReactDefaultBatchingStrategy = __webpack_require__(53);
	var ReactDOMComponent = __webpack_require__(42);
	var ReactDOMButton = __webpack_require__(54);
	var ReactDOMForm = __webpack_require__(55);
	var ReactDOMImg = __webpack_require__(56);
	var ReactDOMIDOperations = __webpack_require__(57);
	var ReactDOMIframe = __webpack_require__(58);
	var ReactDOMInput = __webpack_require__(59);
	var ReactDOMOption = __webpack_require__(60);
	var ReactDOMSelect = __webpack_require__(61);
	var ReactDOMTextarea = __webpack_require__(62);
	var ReactDOMTextComponent = __webpack_require__(12);
	var ReactElement = __webpack_require__(9);
	var ReactEventListener = __webpack_require__(63);
	var ReactInjection = __webpack_require__(64);
	var ReactInstanceHandles = __webpack_require__(14);
	var ReactMount = __webpack_require__(15);
	var ReactReconcileTransaction = __webpack_require__(65);
	var SelectEventPlugin = __webpack_require__(66);
	var ServerReactRootIndex = __webpack_require__(67);
	var SimpleEventPlugin = __webpack_require__(68);
	var SVGDOMPropertyConfig = __webpack_require__(69);

	var createFullPageComponent = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getReactRootElementInContainer = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(27);
	var LocalEventTrapMixin = __webpack_require__(101);
	var ReactBrowserComponentMixin = __webpack_require__(52);
	var ReactClass = __webpack_require__(6);
	var ReactElement = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPutListenerQueue = __webpack_require__(109);
	var Transaction = __webpack_require__(99);
